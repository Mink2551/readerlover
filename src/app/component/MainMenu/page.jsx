  ...
  return (
    <div>
      ...
      <div className="mx-auto grid w-fit mb-16 mt-16">
        ...
        <Link href="#" className="gradient-bg hover:animated-outline duration-300 mt-5 font-bold text-lg text-center hover:scale-105 hover:text-gray-100 cursor-pointer hover:text-xl text-gray-300 hover:gradient-hover px-16 py-2 rounded-full shadow-2xl">How to use</Link>
